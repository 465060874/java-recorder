...
public class GifWriter {
     ...
     */
    public GifWriter(ImageOutputStream outputStream, int imageType, int timeBetweenFramesMS, boolean loopContinuously)
    ...
    /**
     * Close this GifWriter object. This does not close the underlying stream, just finishes
     * off the GIF.
     */
